...
![Example list of hazards](~/list-of-hazards.webp "Figure 1: Example list of hazards.")
...
![Foundational risk assessment cycle](~/risk-assessment-cycle.webp "Figure 2: A foundational risk assessment cycle.")
...
![Configurational risk assessment example for a single hazard.](~/configurational-risk-assessment.webp "Figure 3: Configurational risk assessment example (single hazard).")
