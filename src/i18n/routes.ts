...
//
// routes = { 
//  { lang_1: slug, lang_2: slug, ..., lang_N: slug }  // For all routes ending in that slug
//  { lang_1: collection/slug, lang_2: collection/slug, ..., lang_N: collection/slug } // For specific routs inside a collection
//  ...
// }
...
export const routes: Multi[] = [
  { en: "services", es: "servicios", fi: "palvelut" },  // Tag equivalence
